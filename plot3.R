...
with(hhep, plot(DateTime, Sub_metering_1, type = "n", ylab = "Energy sub metering", xlab = ""))
with(hhep, lines(DateTime, Sub_metering_1, col = "black"))
with(hhep, lines(DateTime, Sub_metering_2, col = "red"))
with(hhep, lines(DateTime, Sub_metering_3, col = "blue"))
